...
const SOURCES: readonly SourceDefinition[] = [
  {
    ...
    languages: ["en"],
    ocr: "never",
    description: "Official Maharashtra Acts and bills published in Part 8 English Extra-Ordinary; complete query coverage now runs from the 2015 product floor through the accepted 2026-07-16 baseline end.",
    acceptance: [
      "195 rows across 2 pages for the accepted 2025-04-09 through 2026-07-16 baseline",
      "Complete non-overlapping historical query coverage from 2015-01-01 through 2025-04-08",
      "Maharashtra Acts LXIII/2025, XIII/2026, XVI/2026, and XXIX/2026",
    ],
  },
  {
    ...
    description: "Official Maharashtra notifications published in Part IV-B; the accepted baseline covers 2021-07-17 through 2026-07-19, complete historical query runs cover 2015 through 2020, and early 2021 has one explicitly identified inaccessible document out of 208 listed rows.",
    acceptance: [
      ...
      "Complete historical query runs for 2015 through 2020 and 207/208 archived rows for 2021-01-01 through 2021-07-16",
      "2026-01-09 Mudrank-2024/C.R.182/Mudrank-2 notification",
    ],
  },
  {
    id: "mh-igr-publications",
    jurisdiction: "MH",
    name: "Maharashtra IGR Publications",
    owner: "Department of Registration and Stamps, Government of Maharashtra",
    baseUrl: "https://igrmaharashtra.gov.in/",
    probeUrl: "https://igrmaharashtra.gov.in/Marathi/publication",
    ...
    languages: ["en", "mr"],
    ocr: "recorded_fallback",
    description: "Official IGR Maharashtra publication portal for Acts, rules, notifications, circulars, valuation rates, fee material, and departmental guidance; reachability alone does not establish history or currency.",
  },
  {
    id: "gj-egazette",
    jurisdiction: "GJ",
